<%@ Page Title="تکلیف بازار - ناحیه کاربری" Language="C#" MasterPageFile="~/Class.master" AutoEventWireup="true" CodeFile="USetting.aspx.cs" Inherits="USetting"%>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
           <ul class="nav nav-sidebar">
            ...
            <li><a href="Finance">مالی</a></li>            
          </ul>
          <ul class="nav nav-sidebar">
            <li class="active"><a href="Setting">تنظیمات</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="alert alert-info" style="width:60%; position:absolute; top:50px; left:300px; z-index:1000; display:none;" id="lblMessage">
                          ...
                          <td style="width:180px;">
                              <div class="input-group">
                                  ...
                                  <div class="input-group-btn">
                                      <button class="btn btn-default" id="btnMobileVerify" runat="server" type="button" onclick="javascript:document.getElementById('ContentPlaceHolder1_txtMobile').disabled = '';"><i class="glyphicon glyphicon-refresh"></i></button>
                                  </div>
                              </div>
                          </td>
                          <td class="text-center" style="width:40%;">
                              <div id="lblMobileVerification" runat="server">
