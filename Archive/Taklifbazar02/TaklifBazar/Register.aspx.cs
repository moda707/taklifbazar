...
public partial class Register : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            ...
            newUser.Education = User_Education.Arshad;// (User_Education)(Convert.ToInt16(optEducation.Items[optEducation.SelectedIndex].Value));
            newUser.Field = User_Field.All; //(User_Field)(Convert.ToInt16(optField.Items[optField.SelectedIndex].Value));
            newUser.Job = User_Job.Employee;// (User_Job)(Convert.ToInt16(optJob.Items[optJob.SelectedIndex].Value));
            ...
            if (UserCode != "")
            {
                ...
                EmailBody += "http://localhost:23524/Register/" + Encryption.Encrypt("EmailVerified&" + UserCode, SharedDataInfo.SecurityKey);
                ...
                if (ES.SendEmail())
                {                    
                    Response.Redirect("/Register/" + Encryption.Encrypt("FormSent", SharedDataInfo.SecurityKey));
                }
                else
                {
                    //Error Send Email
    ...
    protected void btnSubmitVerificationCode_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("/Register/" + Encryption.Encrypt("MobileVerified",SharedDataInfo.SecurityKey));
            Session.Remove("MC");
        }
        else
        {
