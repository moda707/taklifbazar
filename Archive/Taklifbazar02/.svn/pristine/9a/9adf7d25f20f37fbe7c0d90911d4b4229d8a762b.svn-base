...
public partial class USetting : System.Web.UI.Page
{
    ...
    protected void FillForm()
    {
        ...
        if (CurU.MobileVerification == 1)
        {
            ...
            lblMobileVerification.InnerHtml = "<span class=\"text-danger\" style=\"font-size:9pt;\">شماره تائید نشده است  </span> <button class=\"btn btn-success\" type=\"button\" id=\"btnMobileVerificationForm\" onclick=\"javascript:\">تائید شماره</button>";
