...
<html lang="en">
	<head>
		...
		<link rel="shortcut icon" href="http://localhost:23524/book-black.ico" /> 
	...
	<body>
        <div class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="vertical-align:middle;">	
	        <div class="navbar-header">
                ...
                <img src="../images/book-white.png" style="width:40px; height:40px;" />
		        <a class="navbar-brand" rel="home" href="Default.aspx">تـــکلیف بـــازار</a>
                        ...
                        <div class="dropdown-menu pull-left fluid" style="padding:17px;">              
              	            <div class="form-group">
                                ...
                                <label class="optional" for="user_remember_me"> بخاطر بسپار </label>
  				                <br/>
                                <button type="button" id="btnLogin" class="btn" onclick="javascript: location.href='../User/Dashboard'">ورود</button>
                                <button type="button" id="btnSignup" class="btn" onclick="javascript: location.href='../Register/From'">عضویت</button>
                            </div>
                        </div>
                    </li>         
		        </ul>
	        ...
	        <div class="col-sm-6 col-md-6" style="margin-top:8px;">
		        ...
		        <div class="input-group" style="vertical-align:middle;">
			        <input type="text" class="form-control" id="srchterm" onkeyup="if (event.keyCode == 13) DoSearch();" runat="server"/>                    
