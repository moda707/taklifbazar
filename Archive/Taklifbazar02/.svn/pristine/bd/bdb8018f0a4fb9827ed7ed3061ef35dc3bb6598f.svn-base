...
<br /><br /><br />
    <div class="container" align="center" style="text-align:center; width:60%;">
        ...
        <div class="row placeholders">
                      ...
                      <tr>
                          ...
                          <td style="width:300px;" >
                              ...
                              <input style="direction:ltr;" type="text" class="form-control" runat="server" id="txtMobile">                                  
                                  <span style="direction:ltr;" class="input-group-addon">+989</span>
                                  </div>
                          </td>
                          <td style="text-align:right;">
                              توضیحات
                ...
                <div class="panel panel-default">
                  ...
                  <table class="table">
                      <tr>
                          ...
                          <td style="width:300px;" >
                              <div class="input-group" style="width:200px;">                                  
                                  <input style="text-align:left;" type="text" class="form-control" runat="server" id="txtUsername">
                      ...
                      <tr>
                          ...
                          <td style="width:300px;" >
                              <input style="text-align:left;" type="text" class="form-control" runat="server" id="txtPass">                                  
                          </td>
                          <td style="text-align:right;">
                              توضیحات
                          </td>
                      ...
                      <tr>
                          ...
                          <td style="width:300px;" >
                              <input style="text-align:left;" type="text" class="form-control" runat="server" id="txtRePass">                                  
                          </td>
                          <td style="text-align:right;">
                              توضیحات
                          </td>
                      ...
                      <tr>
                            <td colspan="2">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" checked runat="server" id="chkMail1"> دریافت ایمیل صورت حساب ماهیانه
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" checked runat="server" id="chkSMS1"> دریافت پیامک صورت حساب ماهیانه
                                    </label>
                                </div>
                            </td>
                        </tr>
            ...
            <div class="col-xs-12 col-sm-12 placeholder">
                <div class="panel panel-default">
                  <div class="panel-heading">اطلاعات حساب بانکی</div>
                  <table class="table">
                      <tr>
                          <td style="width:110px;">
                          ...
                          <td>
                            ...
                            <td>
                                <select style="font-size:9pt;" class="form-control" id="optSettlement" runat="server">
                                    <option value="0" selected>ماهیانه</option>
