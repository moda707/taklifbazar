<%@ Page Title="" Language="C#" MasterPageFile="~/Class.master" AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="Register"%>
...
<br /><br /><br />
    <div class="container" align="center" style="text-align:center; width:60%;">
        <% if((Encryption.Decrypt((Request.QueryString[""].ToString()).Replace(' ','+'),SharedDataInfo.SecurityKey)).Split('&')[0].Replace("State=","") == "Form"){ %>
        ...
        <div class="row placeholders">
                  ...
                  <table class="table">
                      <tr>
                          ...
                          <td style="text-align:right;">
                              <asp:RequiredFieldValidator ForeColor="Red" ControlToValidate="txtFFName" ErrorMessag="این فیلد الزامیست." runat="server" ID="RFVFFName"></asp:RequiredFieldValidator>
                          </td>
                      </tr>
                      <tr>
                          <td style="width:110px;">
                          ...
                          <td style="text-align:right;">
                              <asp:RequiredFieldValidator ForeColor="Red" ControlToValidate="txtFLName" ErrorMessag="این فیلد الزامیست." runat="server" ID="RFVFLName"></asp:RequiredFieldValidator>
                          </td>
                      </tr>
                      <tr>
                          <td style="width:110px;">
                          ...
                          <td style="width:300px;" >
                              <input style="direction:ltr;text-align:left;" type="text" class="form-control" runat="server" id="txtEFName"/>                                  
                          </td>
                          <td style="text-align:right;">
                              <asp:RequiredFieldValidator ForeColor="Red" ControlToValidate="txtEFName" ErrorMessag="این فیلد الزامیست." runat="server" ID="RFVEFName"></asp:RequiredFieldValidator>
                          </td>
                      </tr>
                      <tr>
                          <td style="width:110px;">
                          ...
                          <td style="width:300px;" >
                              <input style="direction:ltr;text-align:left;" type="text" class="form-control" runat="server" id="txtELName"/>                                  
                          </td>
                          <td style="text-align:right;">
                              <asp:RequiredFieldValidator ForeColor="Red" ControlToValidate="txtELName" ErrorMessag="این فیلد الزامیست." runat="server" ID="RFVELName"></asp:RequiredFieldValidator>
                          </td>
                      </tr>
                    </table>
                </div>
                ...
                <div class="panel panel-default">
                  ...
                  <table class="table">
                      ...
                      <tr>
                          ...
                          <td style="width:300px;" >
                              <input style="direction:ltr;text-align:left;" type="text" class="form-control" runat="server" id="txtPhone"/>                                  
                          </td>
                          <td style="text-align:right;">
                              <asp:RequiredFieldValidator ForeColor="Red" ControlToValidate="txtPhone" ErrorMessag="این فیلد الزامیست." runat="server" ID="RFVPhone"></asp:RequiredFieldValidator>
                          </td>
                      </tr>
                      <tr>
                          <td style="width:110px;">
                          ...
                          <td style="text-align:right;">
                              <asp:RequiredFieldValidator ForeColor="Red" ControlToValidate="txtMobile" ErrorMessag="این فیلد الزامیست." runat="server" ID="RFVMobile"></asp:RequiredFieldValidator>
                          </td>
                      </tr>
                    </table>
                </div>
                ...
                <div class="panel panel-default">
                  ...
                  <table class="table">
                      <tr>
                          ...
                          <td style="text-align:right;">
                              <asp:RegularExpressionValidator ControlToValidate="txtUsername" runat="server" ID="REVUsername" ForeColor="Red" 
                                  ValidationExpression="^(?=.{8,20}$)(?![_.])(?!.*[_.]{2})[a-zA-Z0-9._]+(?<![_.])$" ErrorMessage="نام کابری معتبر وارد کنید."></asp:RegularExpressionValidator>
                          </td>
                      </tr>
                      <tr>
                          <td style="width:110px;">
                          ...
                          <td style="width:300px;" >
                              <input style="direction:ltr;text-align:left;" type="text" class="form-control" runat="server" id="txtEmail"/>                                  
                          </td>
                          <td style="text-align:right;">
                              <asp:RegularExpressionValidator ID="regexEmailValid" runat="server" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="txtEmail" ErrorMessage="ایمیل معتبر وارد کنید" ForeColor="Red"></asp:RegularExpressionValidator>
                          </td>
                      </tr>
                      <tr>
                          <td style="width:110px;">
                          ...
                          <td style="width:300px;" >
                              <input style="direction:ltr;text-align:left;" type="password" class="form-control" runat="server" id="txtPass"/>                                  
                          </td>
                          <td style="text-align:right;">
                              <asp:RegularExpressionValidator ID="Regex1" runat="server" ControlToValidate="txtPass"
                            ValidationExpression="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" ErrorMessage="رمز عبور معتبر انتخاب کنید" ForeColor="Red" />
                          </td>
                      </tr>
                      <tr>
                          <td style="width:110px;">
                          ...
                          <td style="width:300px;" >
                              <input style="direction:ltr;text-align:left;" type="password" class="form-control" runat="server" id="txtRePass"/>                                  
                          </td>
                          <td style="text-align:right;">
                              <asp:CompareValidator ID="CompareValidator1" runat="server" 
                                ...
                                ErrorMessage="تکرار رمز عبور با اصل آن مطابق نیست"  ForeColor="Red"/>
                              <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                ErrorMessage="تکرار رمز عبور ضروری است" 
                                ControlToValidate="txtRePass"
            ...
            <div class="col-xs-12 col-sm-12 placeholder">
                <div class="panel panel-default">
                  <div class="panel-heading">اطلاعات حساب بانکی<br />پر کردن این قسمت برای کاربرانی که می خواهند تکلیفی برای فروش بگذارند الزامیست.</div>
                  <table class="table">
                      <tr>
                          <td style="width:110px;">
                          ...
                          <td style="width:300px;" >
                              <div class="input-group" style="width:200px;">                                  
                                  <input style="direction:ltr;text-align:left;" type="text" class="form-control" runat="server" id="txtAccount"/>                                  
                              </div>
                          </td>
                          <td style="text-align:right;">
                              توضیحات
        ...
        <%}
           else if ((Encryption.Decrypt((Request.QueryString[""].ToString()).Replace(' ', '+'), SharedDataInfo.SecurityKey)).Split('&')[0].Replace("State=", "") == "FormSent"){ %>
        <div class="row placeholders">
            <div class="col-xs-12 col-sm-12 placeholder">                
                <div class="panel panel-default">
        ...
        <%}
           else if ((Encryption.Decrypt((Request.QueryString[""].ToString()).Replace(' ', '+'), SharedDataInfo.SecurityKey)).Split('&')[0].Replace("State=", "") == "EmailVerified")
           { %>
        <div class="row placeholders">
            <div class="col-xs-12 col-sm-12 placeholder">                
        ...
        <%}
           else if ((Encryption.Decrypt((Request.QueryString[""].ToString()).Replace(' ', '+'), SharedDataInfo.SecurityKey)).Split('&')[0].Replace("State=", "") == "MobileVerified"){ %>
        <div class="row placeholders">
            <div class="col-xs-12 col-sm-12 placeholder">                
                <div class="panel panel-default">
                    <div class="panel-heading">اتمام فرایند عضویت</div>
                    <div class="panel-body" style="text-align:center;">
                        <span class="label label-success">فرایند عضویت با موفقیت به پایان رسید. <br /> تا لحظاتی دیگر بصورت خودکار وارد سیستم می شوید. در غیر اینصورت از <a href="">اینجا</a> وارد ناحیه کاربری خود شوید.</span>
                    </div>
                </div>
            </div>                    
        </div>
