...
namespace vtocSqlInterface
{
        ...
        public static void ReplaceCodalSymbolsWithTseSymbols(ref DataSet ds, sqlInterface mySqlinterface)
        {
            ...
            foreach (DataTable table in ds.Tables)
            {
                ...
                foreach (DataRow row in table.Rows)
                {
                    ...
                    var myDt = mySqlinterface.SqlExecuteReader(sqlCmd);
    ...
    public class sqlInterface
    {
        ...
        public DataTable SqlExecuteReader(string queryString,int timeoutValue=0)
        {
            //string connetionString = sqlGetConnectionString();
            //ExecuteReader            
        ...
        public bool SqlExecuteNonQuery(string queryString, int timeoutValue=0)
        {
            bool result = false;
            //string connetionString = sqlGetConnectionString();
            try
        ...
        */
        ...
        private List<string> GetUniqueIndexKeys(string databaseTableName, string databaseName = "", string schemaName = "")
        {
            try
            {
                ...
                DataTable myDt4123 = SqlExecuteReader(thissqlcmd);
